...
from config import COLOR_BTN, COLOR_BTN_CONFIRMACION, COLOR_CURSOR_ENCIMA, COLOR_BACKGROUND, COLOR_BACKGROUND_IMAGENES, COLOR_BORDE_LOGO, COLOR_BORDE_BTN, COLOR_PANEL, COLOR_BTN_INSTRUCIONES, COLOR_BORDE_INSTRUCIONES, COLOR_BLANCO
import Util.util_ventana as util_ventana
from Util.util_imagenes import resourse_path
import random
from controlador import Controlador
from PIL import Image, ImageTk
from Formularios.form_MatrizPaso_1 import Formulario_MatrizPaso1
...
class Formulario_MatrizAdyacencia(tk.Toplevel):
    ...
    def Form_Paso1(self):
        paso2 = Formulario_MatrizPaso1(self.matriz_adyacencia, self.filas_indices, self.columnas_indices)
        self.withdraw()
        self.withdraw()
        paso2.grab_set()
